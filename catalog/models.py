...
class Book(models.Model):
    """Model representing a book(but not a especific copy of the book)."""
    title = models.CharField(max_length=200)

    # ForeignKey used because book can only have one author, but authors can have multiple books
    # Author has a string rather than object because it hasn't been declared yet in the file
...
class BookInstance(models.Model):
    """Model representing  a especific copy of a book(i.e that can be borrowed from the library)."""
